...
namespace POS
{
    public partial class Loc_FOC : Form
    {
        ...
        private void Loc_FOC_Load(object sender, EventArgs e)
        {
            ...
            {
                HeaderTitle = "Tester";
                System.Data.Objects.ObjectResult<String> Id = entity.InsertTransaction(DateTime.Now, MemberShip.UserId, MemberShip.CounterId, TransactionType.Sale, true, true, 6, ExtraTax + Tax, ExtraDiscount + Discount, totalCost, 0, null, CustomerId, SettingController.DefaultShop.ShortCode, SettingController.DefaultShop.Id);
